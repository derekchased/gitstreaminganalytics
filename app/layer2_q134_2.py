...
consumer = client.subscribe('topic_q134_1111', subscription_name='github_sub_1', consumer_type=pulsar.ConsumerType.Shared)

# create producer 
producer_layer2 = client.create_producer('topic_q134_2222')
...
tokens = get_tokens(["githubtoken_jonas_2.txt", "githubtoken_jonas.txt", "githubtoken_alvaro.txt", "githubtoken_derek.txt"])
start = time.time()
while True:
