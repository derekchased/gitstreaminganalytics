...
consumer = client.subscribe('topic_q2_11', subscription_name='github_sub_1', consumer_type=pulsar.ConsumerType.Shared)

# create producer 
producer_q2_layer2 = client.create_producer('topic_q2_22')
